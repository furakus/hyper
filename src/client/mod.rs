...
type TokioClient<B> = ClientProxy<Message<proto::ConnHead<proto::RequestLine>, B>, Message<proto::ConnHead<proto::RawStatus>, TokioBody>, ::Error>;
...
where T: AsyncRead + AsyncWrite + 'static,
      ...
      B::Item: AsRef<[u8]>,
{
    type Request = proto::ConnHead<proto::RequestLine>;
    type RequestBody = B::Item;
    type Response = proto::ConnHead<proto::RawStatus>;
